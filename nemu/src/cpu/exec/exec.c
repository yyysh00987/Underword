...
make_group(group2_cl_v,
	inv, inv, inv, inv, 
	shl_rm_cl_v, inv, inv, inv)//sar_rm_cl_v

/* 0xf6 */
make_group(group3_b,
	inv, inv, inv, inv, //test
	inv, inv, inv, inv)

/* 0xf7 */
make_group(group3_v,
	inv, inv, not_rm_v, neg_rm_v, //test
...
/* 0x00 */	inv, add_r2rm_v,inv,inv,//4add_rm2r_v
...
/* 0xe8 */	call_si_v, jmp_si_l, inv, jmp_si_b,
